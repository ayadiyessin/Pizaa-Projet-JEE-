...
<head>
<meta charset="UTF-8">
<title>Inscription Client | Client</title>
</head>
<link
			...
			<div class="row justify-content-md-center">
				<div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6">
					<div class="bg-white p-4 p-md-5 rounded shadow-sm">
						...
						%>
						<form class="contact-form" action="../ClientController"
							method="post">
							<div class="row gy-3 gy-md-4 overflow-hidden">
								...
								<div class="form-group col-md-6">
									<label for="nom" class="form-label">Nom <span
										...
										value="<%=(nom != null) ? nom : ""%>" required
										onblur="validateNom()" oninput="clearNomError()">
								...
								<div class="form-group col-md-6">
									<label for="prenom" class="form-label">Prenom <span
										...
										placeholder="Prenom"
										value="<%=(prenom != null) ? prenom : ""%>" required
										onblur="validatePrenom()" oninput="clearPrenomError()">
								...
								<div class="form-group col-md-6">
									<label for="adresse" class="form-label">Adresse <span
										...
										placeholder="Adresse"
										value="<%=(adresse != null) ? adresse : ""%>" required
										onblur="validateAdresse()" oninput="clearAdresseError()">
									<div id="adresseError" class="text-danger"></div>
								</div>
								<div class="form-group col-md-6">
									<label for="tell" class="form-label">Numéro Telephone <span
										class="text-danger">*</span></label> <input type="text"
										class="form-control" name="tell" id="tell"
										placeholder="20055401"
										value="<%=(tell != null) ? tell : ""%>" required
										onblur="validateTell()" oninput="clearTellError()">
								...
								<div class="col-12">
									<div class="d-grid">
										<button class="btn btn-lg btn-primary" name='inscription'
											id="inscriptionBtn" type="submit">S’inscrire</button>
									</div>
								</div>
							</div>
						</form>
						<div class="row">
							<div class="col-12">
								...
								<div
									...
									<a href="authentificationClinet.jsp"
										class="link-secondary text-decoration-none btt">Connexion</a>
