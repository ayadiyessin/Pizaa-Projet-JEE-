          ...
          <form action="#!">
            <div class="row gy-3 gy-md-4 overflow-hidden">
              ...
              <div class="col-12">
                ...
                <input type="text" class="form-control" name="tell" id="tell" placeholder="20055401" required>
              </div>
              <div class="col-12">
                <div class="d-grid">
          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                <a href="authentificationClinet.jsp" class="link-secondary text-decoration-none">Connexion</a>
