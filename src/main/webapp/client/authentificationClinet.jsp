...
<head>
<meta charset="UTF-8">
<title>Authentification Client | Client</title>
</head>
<link
...
<body>
				...
				<ul class="navbar-nav ml-auto">
					...
					<c:choose>
						<c:when test="${not empty sessionScope.client}">
							<c:choose>
								<c:when test="${sessionScope.length == 0}">s
						...
						<div class="row">
							<div class="col-12">
								...
								<div
									...
									<a href="inscriClient.jsp"
										class="link-secondary text-decoration-none">créez un
										compte</a>
	...
	<footer style="margin-top: 10px;" class="ftco-footer ftco-section img">
