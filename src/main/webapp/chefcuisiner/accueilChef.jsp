...
<head>
<meta charset="UTF-8">
<title>Accueil Chef Cuisiner | Chef Cuisiner</title>
...
<body>
								...
								<c:if test="${not empty lstCom}">
									<c:forEach items="${lstCom}" var="c" varStatus="status">
										<tr class="accueilLiv">
											...
											<td><a href="profileClient.jsp?id=${c.getId_Client()}">Détail
													Client</a></td>
											...
											<td><c:choose>
													<c:when test="${c.etat_com == 'en attente'}">
														...
														<a href="#" class="lancer-commande-btn"
															data-id="${c.getId_com()}" data-bs-toggle="modal"
															data-bs-target="#LancerCommandeModal">Lancer la
															commande</a>

													</c:when>
													<c:when test="${c.etat_com == 'en cours'}">
														<!-- <a href="#" data-bs-toggle="modal" data-bs-target="#LancerCommandeModal"  >Lancer la commande</a> -->
														<a href="FinCommande.jsp?id=${c.getId_com()}">
															Finaliser commande </a>
											...
											<td><a href="commande.jsp?id=${c.id_com}">voir
													commandes </a></td>
										</tr>
									</c:forEach>
								</c:if>
		...
		<div class="modal-dialog ">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Profil de
						l'utilisateur</h5>
	...
	<div class="modal fade" id="ComModal" tabindex="-1"
		aria-labelledby="ComModalLabel" aria-hidden="true">
				...
				<div class="modal-body">
					...
					<div>
						...
						<div class="row">
							...
							<div class="col-md-6">
								<p>
									<strong>Téléphone:</strong> 20055401
								</p>
								<p>
									<strong>Adresse:</strong> Lafran km 5
								</p>
							</div>
						</div>
					</div>
					...
					<div class="mt-4 text-end">
						<div>
							<span><strong>Total:</strong></span> <span>$65</span>
						</div>
						<div class="divider"></div>
						<div>
							<span><strong>Prix de livraison:</strong></span> <span>$7</span>
						</div>
						<div class="divider"></div>
						<div>
							<span><strong>Total à payer:</strong></span> <span>$72</span>
						</div>
					</div>
	...
	<div class="modal fade" id="LancerCommandeModal" tabindex="-1"
		aria-labelledby="LancerCommandeModal" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
						...
						function() {
							...
							$('#confirmLancer')
									.click(
											function() {
												if (commandeId) {
													window.location.href = '../CommandeController?id='
															+ commandeId;
												}
											});
						});
	...
	<div class="modal fade" id="FinaliserCommandeModal" tabindex="-1"
		aria-labelledby="FinaliserCommandeModal" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="list-group">
						...
						<label class="list-group-item"> <input type="radio"
							name="livreur" value="livreur1">
							<div class="d-flex w-100 justify-content-between">
								<h5 class="mb-1">Livreur 1</h5>
							</div>
							<p class="mb-1">Nom: John Doe</p> <small>Email:
								livreur1@example.com</small>
						</label>
						<!-- Livreur 2 -->
						<label class="list-group-item"> <input type="radio"
							name="livreur" value="livreur2">
							<div class="d-flex w-100 justify-content-between">
								<h5 class="mb-1">Livreur 2</h5>
							</div>
							<p class="mb-1">Nom: Jane Doe</p> <small>Email:
								livreur2@example.com</small>
						</label>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary">Finaliser la
						commande</button>
				</div>
			</div>
		</div>
