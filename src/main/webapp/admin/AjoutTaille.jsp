  ...
  <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ajouter Taille</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="accueilAdmin.jsp">Accueil</a></li>
                                <li class="breadcrumb-item"><a href="listTaille.jsp">Liste des Taille</a></li>
                                <li class="breadcrumb-item active">Ajouter Taille</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="col-sm-10">
                    ...
                    <div class="card card-widget ">
                        ...
                        <div class="card-widget bg-info  ">
                            <h3 class="card-widget-username">Ajouter Taille</h3>
                        </div>
                        <!-- /.content -->
