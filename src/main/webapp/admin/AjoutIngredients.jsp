  ...
  <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ajouter Ingredient</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="accueilAdmin.jsp">Accueil</a></li>
                                <li class="breadcrumb-item"><a href="listIngredient.jsp">Liste des Ingredient</a></li>
                                <li class="breadcrumb-item active">Ajouter Ingredient</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="col-sm-10">
                    ...
                    <div class="card card-widget ">
                        ...
                        <div class="card-widget bg-info  ">
                            <h3 class="card-widget-username">Ajouter Ingredient</h3>
                        </div>
                        <!-- /.content -->
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="exampleInputpre">Ingredient</label>
                                ...
                                <div class="card-footer">
                                    ...
                                    <button type="submit" id="btnup" name="insertingredient" class="btn btn-info  float-right"><i class="fa fa-plus">
                                        </i></button>
