	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
				...
				<div class="col-sm-10">
					...
					<div class="card card-widget ">
						...
						<section class="content  ">
							...
							<form method="post" action="modifierCli.php"
								enctype="multipart/form-data">
								<div class="card-body">
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label for="exampleInputnom">ID</label> <input type="text"
													readonly name="cin_client" class="form-control" value="1">
											</div>
										</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label for="exampleInputpre">Nom</label> <input type="text"
													name="nom" class="form-control" value="Ali">
											</div>
										</div>
										<div class="col-sm-6">
											<div class='form-group'>
												<label for='exampleInputpre'>Prenom</label> <input
										...
										<div class="col-sm-12">
											<div class="form-group">
												<label for="exampleInputEmail1">Image</label> <input
													type="text" name="numtel" class="form-control"
													value="http//kjblgvbhukilyhno">
											</div>
										</div>
									</div>
			...
			<a id="back-to-top" href="#" class="btn btn-primary back-to-top"
				role="button" aria-label="Scroll to top"> <i
