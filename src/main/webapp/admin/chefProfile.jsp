          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Liste des Chefs</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-10">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Liste des Chefs</h3>
                        ...
                        <div class='col-12 col-sm-6 col-md-12 d-flex align-items-stretch flex-column'>
                          <div class='card bg-light d-flex flex-fill'>
                            ...
                            <div class='card-body pt-0'>
                              <div class='row'>
                                <div class='col-12'>
                                  <h6 id='icon'><b>Yessin Ayedi</b></h6>
                                  <ul class='ml-4 mb-0 fa-ul text-muted' id='listADM'>
                                    <li id='icon' class='item'><span></span> <b>Login : </b>  yessinayedi@gmail.com</li>
