	...
	$("#searchp").keyup(
			function() {
				...
				for (var i = 0; i < $(".contact").length; i++) {
					...
					if ($(".contact:eq(" + i + ")").text().toLowerCase()
							.indexOf(seterm) < 0) {
									...
									<div class="card-tools">
										<div class="input-group input-group-sm"
											...
											<a class="btn btn-primary float-right"
												href='AjoutLivreur.jsp'><i class='fas fa-plus'></i>
												Ajouter</a>
																...
																<div class='row'>
																	<div class='col-11'>
																		...
																		<ul class='ml-4 mb-0 fa-ul text-muted' id='listADM'>
																			<h6 id='icon'>
																				<b>${c.getNom()} ${c.getPrenom()} </b>
																			</h6>
																			<li id='icon' class='item'><span></span> <b>Login
																					: </b> ${c.getLogin()}</li>
																			<li id='icon' class='item'><span></span> <b>Password
																					: </b> ${c.getPassword()}</li>
					...
					.keyup(
							function() {
								...
								for (var i = 0; i < $(".contact").length; i++) {
									...
									$(".contact:eq(" + i + ")").css("display",
											"flex");
									$(".contact2:eq(" + i + ")").css("display",
											"flex");
									/*If it doesn't match the input it is hidden*/
									if ($(".contact:eq(" + i + ")").text()
											.toLowerCase().indexOf(seterm) < 0) {
										$(".contact:eq(" + i + ")").css(
												"display", "none");
									}
								}
