  ...
  <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Ajouter Pizza</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="accueilAdmin.jsp">Accueil</a></li>
                                <li class="breadcrumb-item"><a href="listPizza.jsp">Liste des Pizza</a></li>
                                <li class="breadcrumb-item active">Ajouter Pizza</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="col-sm-10">
                    ...
                    <div class="card card-widget ">
                        ...
                        <div class="card-widget bg-info  ">
                            <h3 class="card-widget-username">Ajouter Pizza</h3>
                        </div>
                        <!-- /.content -->
                        <section class="content  ">


                            <form method="post" action="../PizzaController">
                            <div class="card-body">
                                    <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="card-footer">
                                    ...
                                    <button type="submit" id="btnup" name="insertpizza" class="btn btn-info  float-right"><i class="fa fa-plus">
                                        </i></button>
